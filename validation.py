...
def valid_model(
    ...
    for val_p, val_s, val_l, val_f0_c in tqdm(valid_loader):
        ...
        out_add, out_sub, out_rec, out_mu, out_logvar, global_amp = model(val_s, norm_l, val_f0, val_s)
...
if __name__ == "__main__":
    ...
    pt_file = "./pt_file/decoder_v19_6_addmfft_energy_loud_nolinear_generator_best_1.pt"
